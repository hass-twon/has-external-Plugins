...
@Slf4j
@Singleton
public class hasNPCDeaggroOverlay extends OverlayPanel {

    private final Client client;
    private final hasNPCDeaggroPlugin plugin;
    private final hasNPCDeaggroConfiguration config;

    String timeFormat;
    private String infoStatus = "Starting...";

    @Inject
    public hasNPCDeaggroOverlay(Client client, hasNPCDeaggroPlugin plugin, hasNPCDeaggroConfiguration config) {
        super(plugin);
